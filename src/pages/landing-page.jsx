    ...
    <main className="flex flex-col md:flex-row items-center justify-between px-4 md:px-10 py-10 md:py-20 bg-white-50">
      <div className="w-full md:max-w-lg">
        ...
        <p className="text-gray-600 mb-6">
          ...
          users have full control over their data and identity.
        </p>
          ...
          <div className="flex flex-col md:flex-row md:justify-between items-center md:items-start mb-12">
            ...
            <div className="md:w-1/2 mt-4 md:mt-0">
              ...
              <p className="text-gray-600 text-sm">
                ...
                Temporibus porro, repellendus natus adipisci iusto et nam error,
                magnam eaque amet alias aliquid ea earum. Unde accusamus quis,
                eius eaque doloremque beatae incidunt soluta labore cumque
                obcaecati quibusdam quas ea fugit est enim?{" "}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-end space-y-4 md:space-y-0 md:space-x-4 mt-4 md:mt-0">
            ...
            <div className="flex space-x-3">
              ...
              <a href="#" aria-label="Discord">
                <img src="/png/discord.png" alt="Discord" className="w-5 h-5" />
              </a>
              <a href="#" aria-label="Twitter">
                <img src="/png/twitter.png" alt="Twitter" className="w-5 h-5" />
              </a>
